...
from transformers import AutoModelForCausalLM, TrainingArguments, AutoModel, Trainer, AutoTokenizer, DataCollatorForLanguageModeling
import logging
import os
...
try:
  ...
  tokenizer = AutoTokenizer.from_pretrained("mistralai/Mistral-7B-Instruct-v0.3") # or google/gemma-7b
  print('here')
  ...
  trainer.save_model("./mistral2_finetuned")
