...
from transformers import AutoModelForCausalLM, TrainingArguments, AutoModel, Trainer, AutoTokenizer, DataCollatorForLanguageModeling, BioGptTokenizer, BioGptForCausalLM
import logging
import os

os.environ["HF_HOME"] = "D:/huggingface_cache"
os.environ["TRANSFORMERS_CACHE"] = "D:/huggingface_cache"
os.environ["HF_DATASETS_CACHE"] = "D:/huggingface_datasets"
...
try:
  ...
  tokenizer = BioGptTokenizer.from_pretrained("microsoft/biogpt") # or google/gemma-7b
  print('here')
...
#   model = AutoModelForCausalLM.from_pretrained("deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B", trust_remote_code=True)
  ...
  trainer.save_model("./dp_finetuned")
