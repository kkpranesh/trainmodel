...
try:
  ...
  tokenizer = AutoTokenizer.from_pretrained("microsoft/Phi-4-multimodal-instruct") # or google/gemma-7b
  print('here')
  ...
  trainer.save_model("./micro_finetuned")
